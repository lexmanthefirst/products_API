 ...
 * tags:
 *   name: Categories
 *   description: Routes for category operations
 */
 ...
 */
router.get('/', Util.handleErrors(categoryController.getAll));
 ...
 */
router.get('/:id', Util.handleErrors(categoryController.getById));
